...
func TestOpenAIClientEmbedIdentityUsesEffectiveBaseURL(t *testing.T) {
	fallback := NewOpenAIClient("key", "https://chat.example/v1", "", "", "", "chat", "embed", ChatOptions{})
	...
	explicit := NewOpenAIClient("key", "https://chat.example/v1", "https://embed.example/v1", "", "", "chat", "embed", ChatOptions{})
